...
var Aufgabe2_Skipiste;
(function (Aufgabe2_Skipiste) {
    ...
    function init() {
        ...
        crc2.closePath();
        //Schneeflocken//       
        drawSnowflake1(20, 20, 2, 0, 2, "#FFFFFF"); //gr��erer Radius
        drawSnowflake2(40, 40, 1, 0, 2, "#FFFFFF"); //kleinerer Radius
        //100 gr��ere Flocken zuf�llig platzieren
        for (let i = 0; i < 100; i++) {
            let x = 0 + Math.random() * canvas.width;
            let y = 0 + Math.random() * 450;
            let radius = 2;
            let startAngle = 0;
            let endAngle = 2;
            drawSnowflake1(x, y, radius, startAngle, endAngle, "#FFFFFF");
        }
        //200 kleinere Flocken zuf�llig platzieren
        for (let i = 0; i < 200; i++) {
            let x = 0 + Math.random() * canvas.width;
            let y = 0 + Math.random() * 450;
            let radius = 1;
        ...
        function drawSnowflake2(_x, _y, _radius, _startAngle, _endAngle, _color) {
            crc2.beginPath();
            crc2.arc(_x, _y, _radius, _startAngle, _endAngle * Math.PI);
            crc2.strokeStyle = _color;
            crc2.stroke();
...
})(Aufgabe2_Skipiste || (Aufgabe2_Skipiste = {}));
