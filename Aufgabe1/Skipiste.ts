...
function init(): void {
    ...
    function drawSky(_x: number, _y: number, _strokeStyle: string, _fillStyle: string): void {
        crc2.beginPath();
    ...
    function drawSun(_x: number, _y: number, _strokeStyle: string, _fillStyle: string): void {
        crc2.beginPath();
    ...
    function drawCloud1(_x: number, _y: number, _strokeStyle: string, _fillStyle: string): void {
        //Kreis links
        crc2.beginPath();
    ...
    function drawCloud2(_x: number, _y: number, _strokeStyle: string, _fillStyle: string): void {
        //Kreis links
        crc2.beginPath();
    ...
    function drawMountain2(_x: number, _y: number, _strokeStyle: string, _fillSytle: string): void {
        crc2.beginPath();
        crc2.moveTo(100, 400);
        crc2.lineTo(320, 200);
        crc2.lineTo(550, 400);
    ...
    function drawMountain3(_x: number, _y: number, _strokeStyle: string, _fillSytle: string): void {
        crc2.beginPath();
        crc2.moveTo(180, 450);
        crc2.lineTo(500, 150);
        crc2.lineTo(680, 450);
    ...
    function drawMountain1(_x: number, _y: number, _strokeStyle: string, _fillSytle: string): void {
        crc2.beginPath();
        crc2.moveTo(10, 450);
        crc2.lineTo(230, 200);
        crc2.lineTo(451, 450);
    ...
    function drawHut(_x: number, _y: number, _strokeStyle: string, _fillStyle: string): void {
        //Vorne
        crc2.beginPath();
        crc2.moveTo(740, 410);
        crc2.lineTo(770, 410);
    ...
    function drawHill1(_cp1x: number, _cp1y: number, _cp2x: number, _cp2y: number, _x: number, _y: number, _strokeStyle: string, _fillStyle: string): void {
        crc2.beginPath();
        crc2.moveTo(0, 400);
    ...
    function drawHill2(_cp1x: number, _cp1y: number, _cp2x: number, _cp2y: number, _x: number, _y: number, _strokeStyle: string, _fillStyle: string): void {
        crc2.beginPath();
        crc2.moveTo(120, 540);
    ...
    function drawHill3(_x: number, _y: number, strokeStyle: string, _fillStyle: string): void {
        crc2.beginPath();
    ...
    function drawTree1(_x: number, _y: number, _strokeStyle: string, _fillStyle: string): void {
        crc2.beginPath();
        crc2.moveTo(40, 396);
        crc2.lineTo(55, 370);
        crc2.lineTo(70, 395);
    ...
    function drawTree2(_x: number, _y: number, _strokeStyle: string, _fillStyle: string): void {
        crc2.beginPath();
        crc2.moveTo(80, 395);
        crc2.lineTo(95, 370);
        crc2.lineTo(110, 396);
    ...
    function drawTree3(_x: number, _y: number, _strokeStyle: string, _fillStyle: string): void {
        crc2.beginPath();
        crc2.moveTo(640, 379);
        crc2.lineTo(655, 360);
        crc2.lineTo(670, 382);
    ...
    function drawTree4(_x: number, _y: number, _strokeStyle: string, _fillStyle: string): void {
        crc2.beginPath();
        crc2.moveTo(320, 600);
        crc2.lineTo(340, 570);
        crc2.lineTo(360, 600);
    ...
    function drawTree5(_x: number, _y: number, _strokeStyle: string, _fillStyle: string): void {
        crc2.beginPath();
        crc2.moveTo(370, 600);
        crc2.lineTo(395, 560);
        crc2.lineTo(420, 600);
    ...
    function drawLift(_x: number, _y: number, strokeStyle: string, fillStyle: string): void {
        //Seil
        crc2.beginPath()
        crc2.moveTo(0, 150);
        crc2.lineTo(800, 80);
    ...
    function drawSnowman(_x: number, _y: number, _strokeStyle: string, _fillStyle: string): void {
        //Körper
        crc2.beginPath();
    ...
    function drawSki(_x: number, _y: number, _strokeStyle: string, _fillStyle: string): void {
        //Erster Skier
        crc2.beginPath();
        crc2.moveTo(700, 600);
        crc2.lineTo(697, 550);
